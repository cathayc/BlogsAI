...
from blogsai.analysis.openai_client import APIKeyInvalidError
...
class TestAnalysisWorker(unittest.TestCase):
    ...
    def test_execute_task_analysis_only(self, MockAnalysisEngine):
        ...
        mock_engine.generate_intelligence_report_from_articles.return_value = {'success': True}
        ...
        mock_engine.generate_intelligence_report_from_articles.assert_called_once()
    ...
    def test_handle_api_key_error(self, MockAnalysisEngine):
        ...
        mock_engine = MockAnalysisEngine.return_value
        mock_engine.generate_intelligence_report.side_effect = APIKeyInvalidError('API Key Error')
